...
const showResult = (name, country,temp, humidity, wind_speed,currentTime) => `<div class="w-30 flex justify-center">
<div
...
>
  <h2 class="text-md mb-2 px-2 pt-2">
    <div class="flex justify-between">
      <div class="badge relative top-0">
        <span
          class="mt-2 py-1 h-12px text-md font-semibold w-12px rounded right-1 bottom-1 px-2"
          >${name}, ${country}</span
        >
      </div>
  ...
  <div class="flex items-center p-2">
    <div class="flex justify-center items-center w-full">
      <svg
        ...
        width="20"
        viewBox="0 0 32 32"
        class="fill-current h-20 w-20 text-yellow-300"
      >
        <path
  ...
  <div class="text-md pt-2 pb-2 px-2">
